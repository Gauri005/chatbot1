...
// welcome
appendBubble('<b>Health Friendly Bot:</b> Hi — describe your symptoms (example: "fever and cough for 2 days"). I provide possible conditions and triage suggestions (not a diagnosis).', 'bot');
